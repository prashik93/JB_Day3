public class Main {
    public static void main(String[] args) {
        ...
        int[] arr7 = {1,2,3,4,3,5,8,9,7,8};
        OddPositionElement oddObj = new OddPositionElement();
        oddObj.oddPositionElement(arr7);
        ...
        int[] arr10 = {20,4,7,9,13,21,8,10};
        SecondLargestNumber secObj = new SecondLargestNumber();
        secObj.secondLargestNumber(arr10);
    }
}